...
Beginner rule: If it doesn’t beat top pair by the river, fold to heavy pressure.

---

### Table Position Explained (Late Position = Power)

Position determines when you act:

- Early = weakest
- Middle = moderate
- Late = strongest
- Blinds = forced, weak postflop
